...
$job_exp = [
    ...
    ['work_name' => 'Window washer',
     'start_date' => 'January 2019',
     'finish_date' => 'May 2021',
    ...
    ['work_name' => 'Vacuum truck driver',
     'start_date' => 'March 2015',
     'finish_date' => 'January 2019',
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php for($i=0;$i<count($job_exp);$i++): ?>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $job_exp[$i]['work_name']; ?> </b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $job_exp[$i]['start_date']; ?> - <span class="w3-tag w3-teal w3-round"><?php echo $job_exp[$i]['finish_date']; ?></span></h6>
          <p><?php echo $job_exp[$i]['description']; ?></p>
          <hr>
        </div>
        <?php endfor;?>
      </div>
